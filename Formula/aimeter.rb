class Aimeter < Formula
  ...
  url "https://github.com/smriti-memcore/aimeter/releases/download/v0.3.4/aimeter-v0.3.4.tar.gz"
  sha256 "ff29c026690b08f852e4f41ec7d077cc6f39b3e7a78b3edbf84ae4d5d9a11bc5"
  license "MIT"
